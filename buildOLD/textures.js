...
export function registerTextures(noa) {
  ...
  for (var i = 1; i < 256; i++) {
    ...
    /* } else if (i === 18) {
      ...
      var flowerMesh = makeFlowerSpriteMesh(scene, 'https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/1.12.2/assets/minecraft/textures/blocks/tallgrass.png', 'flower');
